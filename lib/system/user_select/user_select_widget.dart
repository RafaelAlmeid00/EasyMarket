...
import 'user_select_model.dart';
export 'user_select_model.dart';

class UserSelectWidget extends StatefulWidget {
  const UserSelectWidget({super.key});
...
class _UserSelectWidgetState extends State<UserSelectWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserSelectModel());
  }
