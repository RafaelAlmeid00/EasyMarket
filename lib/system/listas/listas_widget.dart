      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(40.0, 50.0, 40.0, 0.0),
                child: Text(
                  'Para retornar uma lista basta digitar o nome dela em \"Criar Lista\" na página principal. Clique em um card para ver os produtos.',
              ...
              Padding(
                ...
                child: StreamBuilder<List<ListRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<ListRecord> listViewListRecordList = snapshot.data!;

                    return ListView.builder(
                      padding: EdgeInsets.zero,
                      shrinkWrap: true,
                      scrollDirection: Axis.vertical,
                      itemCount: listViewListRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewListRecord =
                            listViewListRecordList[listViewIndex];
                        return Align(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          highlightColor: Colors.transparent,
                                          onTap: () async {
                                            await listViewListRecord.reference
                                                .delete();
                                          },
                                          child: Icon(
                                            Icons.delete_sharp,
